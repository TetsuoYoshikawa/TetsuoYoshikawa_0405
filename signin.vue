        ...
        <div class="card devise-card">
          <div class="form-wrap">
            ...
            <form>
              ...
              <div class="form-group">
                <input class="form-control" placeholder="ユーザーネーム" type="text" name="name" required autofocus>
              </div>
              <div class="form-group">
                <input class="form-control" placeholder="パスワード" autocomplete="off" type="password" name="password" required>
              </div>
              <div class="form-group">
                <input class="form-control" placeholder="パスワードの確認" autocomplete="off" type="password"
                  name="password_confirmation" required>
              </div>
              <div class="actions">
                <button type="submit" name="commit" class="btn btn-primary w-100">登録する</button>
              </div>
            </form>
            <p class="devise-link">
              アカウントをお持ちですか？
